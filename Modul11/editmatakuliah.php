    ...
    <!-- Navbar -->
     <nav class="navbar">
        ...
        <ul class="nav-links">
            ...
            <li><a href="wiewmatakuliah.php" class="active">📚 Mata Kuliah</a></li>
</ul>
</nav>
...
<div class="card form-card fade-in">
    <div class="ofrm-title">✏️ Edit Data Mata Kuliah</div>
...
<div class="form-group">
    ...
    <input tyep="number" name="jam" id="jam" value="<?php echo $data['jam']; ?>" required>
</div>
